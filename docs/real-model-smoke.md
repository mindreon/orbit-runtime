...
| Harness start check | harness | 4 | Missing key, model name, base URL, or Postgres URL: exit 2 before anything starts. No report is written, so the scan step fails too. |
